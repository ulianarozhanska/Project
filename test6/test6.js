$(function () {
    ...
    setTimeout(function () {
        addQuestion("Что нужно говорить вместо сло про твою любовь?", "Слова про твою неннависть", "Кричать от боли", "Призывать тропикану-женщину", 0, 5, 0);
    }, 600);
    setTimeout(function () {
    ...
    setTimeout(function () {
        addQuestion("В каком случае вс` могло бы быть иначе?", "Если бы ты смог обмануть судьбу", "Когда б я мог тебя забыть", "Когда б я женщин не любил", 0, 5, 5);
    }, 1000);
    setTimeout(function () {
