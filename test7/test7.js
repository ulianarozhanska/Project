$(function () {
    ...
    setTimeout(function () {
        addQuestion5("На що більше схожий ваш дім?", "Штаб-квартира СБУ", "Моя крєпость", "Авансцена", "Проходний двір", "На величезний смітник, який я кличу творча атмосфер");
    }, 300);
    setTimeout(function () {
    ...
    setTimeout(function () {
        addQuestion5("Яка професія вам бі підійшла?", "Реформатор-бунтівник", "Вчитель, лікар", "Актор, продавець-консультант", "Слєсарь", "Науковець");
    }, 500);
});