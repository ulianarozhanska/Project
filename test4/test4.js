$(function(){
    ...
    setTimeout(function () {
        addQuestion("З чим у вас асоціюється Ленін?", "З Мавзолеєм", "З градієнтом, звісно", "З найкращими часами", 0, 11, 0);
    }, 400);
    setTimeout(function () {
        addQuestion("Кого «бил по роже» піонєр Сірожа?", "ШО????", "Октябрьонка Пєтю", "Іноді здається, що мене", 0, 11, 0);
    }, 500);
    setTimeout(function () {
        addQuestion("Як треба виправдовуватись, якщо ви доторкнулися до дівчини без її дозволу?", "Ой, вибачте, я випадково", "Робити вигляд, що нічого не сталося", "Що хочу, те й роблю!", 11, 0, 0);
    }, 600);
    setTimeout(function () {
